...
if __name__ == "__main__":
    ...
    net = SwishNet(input_shape = (9 , 20), classes=2)
...
history = net.fit(X_train, y_train, validation_data=(X_test, y_test), batch_size=100, epochs=50)
net.save('final_model3.h5')
